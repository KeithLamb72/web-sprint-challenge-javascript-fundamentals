...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
//In the code above, there are two functions myFunction() and nestedFunction(). 
//myFunction defines a variable internal using the const keyword which means it is block-scoped and only accessible within the myFunction block.
//nestedFunction is declared inside myFunction so it's a nested function.
//nestedFunction has access to variables and functions defined in the outer scope including internal variable because of scoping.
//As resultof this function it can also access the value of internal variable and log it to console.
...
const zooAnimals = [
  ...
  */
  ...
  function lowPopulationAnimals(zooAnimals) {
    const lowPopAnimals = zooAnimals.filter(animal => animal.population < 5);
  ...
  */
  ...
  function USApop(zooAnimals){
    const totalPopulation = zooAnimals.reduce((accumulator, currentAnimal) => {
